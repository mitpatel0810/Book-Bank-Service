			...
			<div class="row justify-content-md-center h-100">
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
							<div class = "errorMsg">
								<!-- <p style = "color: red">Sorry, you are not a registered user</p>
								<p style = "color: red"> Please sign-up first or check your user-name and password </p> -->
							</div>
							<h4 class="card-title">Register</h4>
							<form method="POST" class="my-login-validation" action="RegistrationServlet">
